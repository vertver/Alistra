...
)
{
	...
	*/
	...
	pTempInputClient->QueryInterface(A_IID_IAudioClient, (void**)&InitedDevices.pInputClient);
	pTempOutputClient->QueryInterface(A_IID_IAudioClient, (void**)&InitedDevices.pOutputClient);
